...
public final class JinroDetailsActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jinro_details_activity);

		Intent mIntent = getIntent();

		String name = mIntent.getExtras().getString("name");
		String univ = mIntent.getExtras().getString("univ");
		String major = mIntent.getExtras().getString("major");
		...
		getSupportActionBar().setSubtitle(univ + " " + major);
	...
	class TestFragmentAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			if (position == 0) {
				Fragment fragment = new JinroDetailsPostingFragment();
				return fragment;
			} else if (position == 1) {
				Fragment fragment = new JinroDetailsProfileFragment();
				return fragment;
			} else {
				Fragment fragment = new JinroDetailsPostingFragment();
				return fragment;
